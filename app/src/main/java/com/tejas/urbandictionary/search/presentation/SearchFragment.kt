...
import com.tejas.urbandictionary.common.util.debounce
import com.tejas.urbandictionary.databinding.SearchFragmentBinding
import com.tejas.urbandictionary.search.presentation.recycler.AutoCompleteResultsAdapter
...
class SearchFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        menu.findItem(R.id.search_menu).initSearchMenu()
    }
    ...
    private fun MenuItem.initSearchMenu() {
        (actionView as SearchView).init()
